...
diff = a_SL3(end,1) - a_i;        % Difference between the initial and final semi-major axes [m]
...
hold on
plot([t_i,t_f/3600],[a_i,a_drag(end,1)],'color',[15 43 184]/255,'LineWidth',1.5)
hold on
plot([t_i,t_f/3600],[a_i,a_SL3(end,1)],'color',[201 4 4]/255,'LineWidth',1.5)
